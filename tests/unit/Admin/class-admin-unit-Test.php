 ...
 * Class Admin_Test
 *
 * @coversDefaultClass \BH_WP_NGL_WP_Mail\Admin\Admin
 */
class Admin_Test extends \Codeception\Test\Unit {
	 ...
	 */
	private $plugin_name = 'bh-wp-ngl-wp-mail';
	...
	public function test_enqueue_styles() {
		...
		$css_file = $plugin_root_dir . '/admin/css/bh-wp-ngl-wp-mail-admin.css';
	...
	public function test_enqueue_scripts() {
		...
		$src       = $plugin_root_dir . '/admin/js/bh-wp-ngl-wp-mail-admin.js';
		$deps      = array( 'jquery' );
		$ver       = $this->version;
		$in_footer = true;
